const translations = {
  fr: {
    ...
    "nav.contact": "Contact",
    "hero.tagline": "Développeur indépendant — cybersécurité, services, petits outils, bots et sites, faits avec soin.",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "hero.tagline": "Independent developer — cybersecurity, services, small tools, bots and websites, made with care.",
  ...
  pt: {
    ...
    "hero.tagline": "Programador independente — cibersegurança, serviços, pequenas ferramentas, bots e sites, feitos com cuidado.",
  ...
  es: {
    ...
    "nav.contact": "Contacto",
    "hero.tagline": "Desarrollador independiente — ciberseguridad, servicios, pequeñas herramientas, bots y sitios, hechos con cuidado.",
  ...
  ru: {
    ...
    "hero.tagline": "Независимый разработчик — кибербезопасность, услуги, небольшие инструменты, боты и сайты, сделанные с заботой.",
  ...
  de: {
    ...
    "nav.contact": "Kontakt",
    "hero.tagline": "Unabhängiger Entwickler — Cybersicherheit, Dienstleistungen, kleine Tools, Bots und Websites, mit Sorgfalt gemacht.",
